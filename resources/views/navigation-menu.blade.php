            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/petakom.png') }}" alt="Petakom" class="block h-20 w-auto" />
                    </a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                <x-jet-responsive-nav-link href="{{ route('all-cash.index') }}">
                All Cash
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Inventory::class)
                <x-jet-responsive-nav-link href="{{ route('inventories.index') }}">
                Inventories
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Category::class)
                ...
                <x-jet-responsive-nav-link href="{{ route('payment-methods.index') }}">
                Payment Methods
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Product::class)
