...
class PermissionsSeeder extends Seeder
{
    public function run()
    {
        ...
        Permission::create(['name' => 'list allcash']);
        Permission::create(['name' => 'view allcash']);
        Permission::create(['name' => 'create allcash']);
        Permission::create(['name' => 'update allcash']);
        Permission::create(['name' => 'delete allcash']);
